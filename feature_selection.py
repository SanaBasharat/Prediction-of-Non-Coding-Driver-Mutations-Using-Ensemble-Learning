...
# COLUMNS_TRAINING_ITER1 = ['GO',  'SpliceAI_pred_DP_AG', 'SpliceAI_pred_DP_AL',  'SpliceAI_pred_DP_DG', 'SpliceAI_pred_DP_DL',  'SpliceAI_pred_DS_DG', '3_prime_UTR_variant',  '5_prime_UTR_variant',
#  'NMD_transcript_variant', 'downstream_gene_variant', 'intron_variant',  'non_coding_transcript_exon_variant', 'non_coding_transcript_variant',  'splice_polypyrimidine_tract_variant',
#  'upstream_gene_variant',  'MODIFIER', 'CTCF_binding_site',  'enhancer', 'nonsense_mediated_decay',  'processed_pseudogene',
#  'processed_transcript',  'retained_intron', 'unprocessed_pseudogene',  'DNA', 'LINE',  'LTR',  'SINE',  'Simple_repeat',  'known_driver_gene_100kb_downstream',
#  'known_driver_gene_100kb_upstream', 'known_driver_gene_10kb_downstream', 'known_driver_gene_10kb_upstream', 'known_driver_gene_2kb_downstream',
#  'known_driver_gene_2kb_upstream', 'splice_donor_region_variant', 'splice_donor_5th_base_variant', 'missense_variant',
#  'synonymous_variant', 'splice_region_variant', 'inframe_insertion', 'frameshift_variant', 'known_lncrna', 'known_lncrna_10kb_downstream',
#  'known_lncrna_10kb_upstream', 'known_lncrna_2kb_downstream', 'known_lncrna_2kb_upstream']

COLUMNS_TRAINING = ['SpliceAI_pred_DS_AG', 'SpliceAI_pred_DS_AL', 'SpliceAI_pred_DS_DG', 'SpliceAI_pred_DS_DL', '3_prime_UTR_variant', '5_prime_UTR_variant',
 'downstream_gene_variant', 'intron_variant', 'non_coding_transcript_exon_variant', 'non_coding_transcript_variant',
 'splice_polypyrimidine_tract_variant', 'upstream_gene_variant', 'MODIFIER', 'CTCF_binding_site', 'enhancer', 'processed_pseudogene',
 'processed_transcript', 'protein_coding', 'retained_intron', 'unprocessed_pseudogene',
 'known_driver_gene_100kb_downstream', 'known_driver_gene_100kb_upstream', 'known_driver_gene_10kb_downstream', 'known_driver_gene_10kb_upstream',
 'known_driver_gene_2kb_upstream', 'splice_donor_region_variant', 'splice_donor_5th_base_variant', 'missense_variant',
 'synonymous_variant', 'splice_region_variant', 'inframe_insertion', 'frameshift_variant',
 'TF_loss', 'TF_gain', 'known_lncrna', 'known_lncrna_10kb_downstream', 'known_lncrna_10kb_upstream', 'known_lncrna_2kb_downstream',
 'known_lncrna_2kb_upstream', 'interactions', 'protein_terms', 'repeat_elements']
...
if __name__ == '__main__':
    ...
    x_train.iloc[:, feat_cols].to_csv('data/feature_selected_after_corr_feateng_corr.csv', index=False)