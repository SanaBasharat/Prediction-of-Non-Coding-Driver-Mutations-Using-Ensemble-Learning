...
def read_ICGC_TCGA_data():
    ...
    """
    icgc = pd.read_csv('data/TableS3_panorama_driver_mutations_ICGC_samples.controlled.csv', sep=',')
    icgc = icgc[icgc['category'] == 'noncoding']    #filter for noncoding mutations
    icgc['data_source'] = 'ICGC'
    tcga = pd.read_csv('data/TableS3_panorama_driver_mutations_TCGA_samples.controlled.csv', sep=',')  # this file is not publicly available and hence is not provided in this repository
